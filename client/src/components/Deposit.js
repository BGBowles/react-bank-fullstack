...
const Deposit = () => {
    ...
    return (
      <>
        { show ? (
            <Card
                header={ <h2>Deposit Component</h2>}
                text={ <h3>Enter your Deposit amount below.</h3> }
                ...
                button={<button
                    ...
                    width="250px"
                    onClick={ handleSubmit }>Submit Deposit</button>}
            ...
            <Card
                ...
                text={ <h3>Your Deposit has been completed.</h3> }
                ...
                button={
                    <button
                        ...
                        onClick={ clearForm }>Click to submit another Deposit.</button>
                }
            >
            </Card>
        )}
